...
########################
# This code re-stores the 2PCFs and 3PCFs measured from the galaxy and mock data, and their covariance matrices, in a form that facilitates parameter estimation in "montepython".
# 
...
for NS in ["North", "South"]:
    for zbin in [1,3]:
        for recon in [False, True]:
            ...
            OUTPUT = "data_and_cov_for_analysis"
            try:
                os.mkdir(OUTPUT)
            except:
                pass
            ...
            if recon == False:
                ...
                with open("%s/DATA_%s_zbin%d_case1.p" % (OUTPUT, NS, zbin), "wb") as pp:
                    pickle.dump(DATA_case1, pp)               
                                                              
                with open("%s/DATA_%s_zbin%d_case2.p" % (OUTPUT, NS, zbin), "wb") as pp:
                    pickle.dump(DATA_case2, pp)               
                                                              
                with open("%s/DATA_%s_zbin%d_case3.p" % (OUTPUT, NS, zbin), "wb") as pp:
                    pickle.dump(DATA_case3, pp)               
                                                              
                with open("%s/DATA_%s_zbin%d_case4.p" % (OUTPUT, NS, zbin), "wb") as pp:
                    pickle.dump(DATA_case4, pp)               
                                                              
                with open("%s/DATA_%s_zbin%d_case5.p" % (OUTPUT, NS, zbin), "wb") as pp:
                    pickle.dump(DATA_case5, pp)               
                                                              
                with open("%s/DATA_%s_zbin%d_case6.p" % (OUTPUT, NS, zbin), "wb") as pp:
                    pickle.dump(DATA_case6, pp)               
                
                with open("%s/DATA_%s_zbin%d_case7.p" % (OUTPUT, NS, zbin), "wb") as pp:
                    pickle.dump(DATA_case7, pp)               
                                                               
                with open("%s/DATA_%s_zbin%d_test1.p" % (OUTPUT, NS, zbin), "wb") as pp:
                    pickle.dump(DATA_test1, pp)               
                                                              
                with open("%s/DATA_%s_zbin%d_test2.p" % (OUTPUT, NS, zbin), "wb") as pp:
                    pickle.dump(DATA_test2, pp)               
                                                              
                with open("%s/DATA_%s_zbin%d_test3.p" % (OUTPUT, NS, zbin), "wb") as pp:
                    pickle.dump(DATA_test3, pp)               
                                                              
                with open("%s/DATA_%s_zbin%d_test4.p" % (OUTPUT, NS, zbin), "wb") as pp:
                    pickle.dump(DATA_test4, pp)
             
            elif recon == True:
            
                with open("%s/DATA_%s_zbin%d_recon_case1.p" % (OUTPUT, NS, zbin), "wb") as pp:
                    pickle.dump(DATA_case1, pp)               
                                                              
                with open("%s/DATA_%s_zbin%d_recon_case2.p" % (OUTPUT, NS, zbin), "wb") as pp:
                    pickle.dump(DATA_case2, pp)               
                                                              
                with open("%s/DATA_%s_zbin%d_recon_case3.p" % (OUTPUT, NS, zbin), "wb") as pp:
                    pickle.dump(DATA_case3, pp)               
                                                              
                with open("%s/DATA_%s_zbin%d_recon_case4.p" % (OUTPUT, NS, zbin), "wb") as pp:
                    pickle.dump(DATA_case4, pp)               
                                                              
                with open("%s/DATA_%s_zbin%d_recon_case5.p" % (OUTPUT, NS, zbin), "wb") as pp:
                    pickle.dump(DATA_case5, pp)               
                                                              
                with open("%s/DATA_%s_zbin%d_recon_case6.p" % (OUTPUT, NS, zbin), "wb") as pp:
                    pickle.dump(DATA_case6, pp)               
                
                with open("%s/DATA_%s_zbin%d_recon_case7.p" % (OUTPUT, NS, zbin), "wb") as pp:
                    pickle.dump(DATA_case7, pp)               
                
                with open("%s/DATA_%s_zbin%d_recon_test1.p" % (OUTPUT, NS, zbin), "wb") as pp:
                    pickle.dump(DATA_test1, pp)               
                                                              
                with open("%s/DATA_%s_zbin%d_recon_test2.p" % (OUTPUT, NS, zbin), "wb") as pp:
                    pickle.dump(DATA_test2, pp)               
                                                              
                with open("%s/DATA_%s_zbin%d_recon_test3.p" % (OUTPUT, NS, zbin), "wb") as pp:
                    pickle.dump(DATA_test3, pp)               
                                                              
                with open("%s/DATA_%s_zbin%d_recon_test4.p" % (OUTPUT, NS, zbin), "wb") as pp:
                    pickle.dump(DATA_test4, pp)
