...
for data_type in MOCK:
    ...
    for lkl in ["DHOST_North_zbin1_case7", "DHOST_North_zbin1_case7_NS", "DHOST_North_zbin1_case7_ZBIN", "DHOST_North_zbin1_case7_TOTAL",\
                "DHOST_South_zbin1_case7", "DHOST_South_zbin1_case7_NS", "DHOST_South_zbin1_case7_ZBIN", "DHOST_South_zbin1_case7_TOTAL",\
                "DHOST_North_zbin3_case7", "DHOST_North_zbin3_case7_NS", "DHOST_North_zbin3_case7_ZBIN", "DHOST_North_zbin3_case7_TOTAL",\
                "DHOST_South_zbin3_case7", "DHOST_South_zbin3_case7_NS", "DHOST_South_zbin3_case7_ZBIN", "DHOST_South_zbin3_case7_TOTAL"]:
...
for data_type in MOCK:
    ...
    for param in ["DHOST.param", "DHOST_North.param", "DHOST_South.param", "DHOST_zbin1.param", "DHOST_zbin3.param",\
                  "DHOST_North_zbin1.param", "DHOST_South_zbin1.param", "DHOST_North_zbin3.param", "DHOST_South_zbin3.param"]:
