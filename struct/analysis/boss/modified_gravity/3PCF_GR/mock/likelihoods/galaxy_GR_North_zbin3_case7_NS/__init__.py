...
class galaxy_GR_North_zbin3_case7_NS(Likelihood):    # initialization routine
    ...
    def loglkl(self, cosmo, data):
        ...
        # varying parameters 
        b1sigma8 = data.mcmc_parameters['b1sigma8_North_zbin3']['current']

        FGsigma8 = data.mcmc_parameters['FGsigma8_North_zbin3']['current']
        FSsigma8 = data.mcmc_parameters['FSsigma8_zbin3']['current']
        FTsigma8 = data.mcmc_parameters['FTsigma8_North_zbin3']['current']
