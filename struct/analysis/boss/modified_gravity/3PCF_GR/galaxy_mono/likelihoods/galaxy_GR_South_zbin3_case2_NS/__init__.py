...
class galaxy_GR_South_zbin3_case2_NS(Likelihood):    # initialization routine
    ...
    def loglkl(self, cosmo, data):
        ...
        # varying parameters 
        b1sigma8 = data.mcmc_parameters['b1sigma8_South_zbin3']['current']

        FGsigma8 = data.mcmc_parameters['FGsigma8_South_zbin3']['current']
        FSsigma8 = data.mcmc_parameters['FSsigma8_zbin3']['current']
        FTsigma8 = data.mcmc_parameters['FTsigma8_South_zbin3']['current']

        XS = 0.0
        XT = 15.0/1144.0

        fsigma8 = data.mcmc_parameters['fsigma8_zbin3']['current']
