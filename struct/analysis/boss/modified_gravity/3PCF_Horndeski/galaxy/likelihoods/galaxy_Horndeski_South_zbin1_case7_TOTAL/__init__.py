...
class galaxy_Horndeski_South_zbin1_case7_TOTAL(Likelihood):    # initialization routine
    ...
    def loglkl(self, cosmo, data):
        ...
        FGsigma8 = data.mcmc_parameters['FGsigma8_South_zbin1']['current']
        FSsigma8 = data.mcmc_parameters['FSsigma8_zbin1']['current']
        FTsigma8 = data.mcmc_parameters['FTsigma8_South_zbin1']['current']
